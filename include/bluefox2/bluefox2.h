...
class Bluefox2 {
 public:
  ...
  //bool GrabImage(sensor_msgs::msg::Image::SharedPtr image_msg);
  bool GrabImage(const sensor_msgs::msg::Image::SharedPtr image_msg);
  //bool GrabImage(const sensor_msgs::msg::Image::SharedPtr image_msg, const sensor_msgs::msg::CameraInfo::SharedPtr cinfo_msg);
