...
public:
    ...
    bool                                GetBestMatchingFirmwareState( void ) const
    {
        return m_pMISettings_AlwaysSelectBestMatchingFirmware->IsChecked();
    }
    ...
    int                                 VerifyFirmware( int deviceIndex );
    bool                                WeekPassedSinceLastUpdatesCheck( void ) const;
    void                                WriteErrorMessage( const wxString& msg );
    void                                WriteLogMessage( const wxString& msg, const wxTextAttr& style = wxTextAttr( GetDefaultTextColour() ) );
...
protected:
    ...
    void                                OnVerifyFirmware( wxCommandEvent& e );
...
private:
    ...
    int                                 VerifyFirmware( Device* pDev, bool boSilentMode );
    ...
    wxMenuItem*                         m_pMIActionVerifyFW;
...
public:
    ...
    //-----------------------------------------------------------------------------
    {
        ...
        miSettings_AlwaysSelectBestMatchingFirmware
#ifdef BUILD_WITH_PROCESSOR_POWER_STATE_CONFIGURATION_SUPPORT
        , miSettings_CPUIdleStatesEnabled
#endif // #ifdef BUILD_WITH_PROCESSOR_POWER_STATE_CONFIGURATION_SUPPORT
    };

    wxMenuItem*                         m_pMISettings_AlwaysSelectBestMatchingFirmware;
    ...
    void                                OnSettings_AlwaysSelectBestMatchingFirmware( wxCommandEvent& e )
    {
        m_pMISettings_AlwaysSelectBestMatchingFirmware->Check( e.IsChecked() );
    }
};
