...
private:
    ...
    wxTextCtrl*                         m_pTCLastTimestampAsTime;
    wxTextCtrl*                         m_pTCLastBufferReceived;
    wxTextCtrl*                         m_pTCLastAcquisitionStartTime;
    wxTextCtrl*                         m_pTCAcquisitionActiveTime;
    ...
    const ActiveIssue&                  GetRequestTimeoutIssue( void ) const;
