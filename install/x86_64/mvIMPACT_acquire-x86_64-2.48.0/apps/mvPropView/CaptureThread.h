...
//-----------------------------------------------------------------------------
{
    ...
    wxDateTime                                  m_lastAcquisitionStartTime;
...
public:
    ...
    void                                        ResetAcquisitionStartTime( void )
    {
        m_lastAcquisitionStartTime = wxDateTime::Now();
    }
    const wxDateTime&                           GetLastAcquisitionStartTime( void ) const
    {
        return m_lastAcquisitionStartTime;
    }
